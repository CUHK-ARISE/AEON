...
textattack attack --recipe textfooler \
                  ...
                  --shuffle False \
                  --num-examples 400 \
                  --log-to-csv data/textattack/textfooler-bert-imdb.csv \
                  --query-budget 1000 \
                  --model-batch-size 32 \
...
textattack attack --recipe textfooler \
                  ...
                  --shuffle False \
                  --num-examples 400 \
                  --log-to-csv data/textattack/textfooler-bert-rtmr.csv \
                  --query-budget 1000 \
                  --model-batch-size 32 \
...
textattack attack --recipe textfooler \
                  ...
                  --shuffle False \
                  --num-examples 400 \
                  --log-to-csv data/textattack/textfooler-bert-agnews.csv \
                  --query-budget 1000 \
                  --model-batch-size 32 \
...
textattack attack --recipe textfooler \
                  ...
                  --shuffle False \
                  --num-examples 400 \
                  --log-to-csv data/textattack/textfooler-bert-mnli.csv \
                  --query-budget 1000 \
                  --model-batch-size 32 \
...
textattack attack --recipe textfooler \
                  ...
                  --shuffle False \
                  --num-examples 400 \
                  --log-to-csv data/textattack/textfooler-bert-snli.csv \
                  --query-budget 1000 \
                  --model-batch-size 32 \
...
textattack attack --recipe textfooler \
                  ...
                  --shuffle False \
                  --num-examples 400 \
                  --log-to-csv data/textattack/textfooler-bert-yelp.csv \
                  --query-budget 1000 \
                  --model-batch-size 32 \
...
textattack attack --recipe textfooler \
                  ...
                  --shuffle False \
                  --num-examples 400 \
                  --log-to-csv data/textattack/textfooler-bert-qqp.csv \
                  --query-budget 1000 \
                  --model-batch-size 32 \