...
textattack attack --recipe pso \
                  ...
                  --shuffle False \
                  --num-examples 400 \
                  --log-to-csv data/textattack/pso-bert-imdb.csv \
                  --query-budget 1000 \
                  --model-batch-size 32 \
...
textattack attack --recipe pso \
                  ...
                  --shuffle False \
                  --num-examples 400 \
                  --log-to-csv data/textattack/pso-bert-rtmr.csv \
                  --query-budget 1000 \
                  --model-batch-size 32 \
...
textattack attack --recipe pso \
                  ...
                  --shuffle False \
                  --num-examples 400 \
                  --log-to-csv data/textattack/pso-bert-agnews.csv \
                  --query-budget 1000 \
                  --model-batch-size 32 \
...
textattack attack --recipe pso \
                  ...
                  --shuffle False \
                  --num-examples 400 \
                  --log-to-csv data/textattack/pso-bert-mnli.csv \
                  --query-budget 1000 \
                  --model-batch-size 32 \
...
textattack attack --recipe pso \
                  ...
                  --shuffle False \
                  --num-examples 400 \
                  --log-to-csv data/textattack/pso-bert-snli.csv \
                  --query-budget 1000 \
                  --model-batch-size 32 \
...
textattack attack --recipe pso \
                  ...
                  --shuffle False \
                  --num-examples 400 \
                  --log-to-csv data/textattack/pso-bert-yelp.csv \
                  --query-budget 1000 \
                  --model-batch-size 32 \
...
textattack attack --recipe pso \
                  ...
                  --shuffle False \
                  --num-examples 400 \
                  --log-to-csv data/textattack/pso-bert-qqp.csv \
                  --query-budget 1000 \
                  --model-batch-size 32 \